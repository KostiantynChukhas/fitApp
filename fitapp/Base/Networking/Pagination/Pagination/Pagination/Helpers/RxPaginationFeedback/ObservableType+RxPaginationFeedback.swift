...
internal typealias PageProvider<PageDependency, Element> = (PageDependency) -> Observable<Page<PageDependency, Element>>
...
extension ObservableType where Element == Any {
    ...
    internal static func paginationSystem<PageDependency: Equatable, Element>(
