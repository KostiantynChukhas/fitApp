...
struct HomeSegmentViewModel: ViewModelProtocol {
    internal struct Input {
        ...
        let homeSegmentUpdated: Observable<Void>
    ...
    internal struct Signals {
        ...
        let homeSegmentUpdated: Publisher<Void> = .init()
    }
    ...
    func transform(_ input: Input, outputHandler: @escaping (Output) -> Void) {
        input.disposeBag.insert([
            ...
            input.homeSegmentUpdated.asObservable().bind(to: signals.homeSegmentUpdated)
        ])
