...
struct MainSegmentViewModel: ViewModelProtocol {
    internal struct Input {
        ...
        let mainSegmentUpdated: Observable<Void>
    ...
    internal struct Signals {
        ...
        let mainSegmentUpdated: Publisher<Void> = .init()
    }
    ...
    func transform(_ input: Input, outputHandler: @escaping (Output) -> Void) {
        input.disposeBag.insert([
            ...
            input.mainSegmentUpdated.asObservable().bind(to: signals.mainSegmentUpdated)
        ])
